...
function optionsframework_options() {
  ...
  $options[] = array( "name" => "Công trình tiêu biểu",
    "type" => "heading");

  //Công trình 1
  $options[] = array( "name" => "Tên công trình 1",
    "desc" => "Nhập tên công trình.",
    "id" => "cong_trinh_title1",
    "std" => "Công trình Cafe",
    "type" => "text");

  $options[] = array( "name" => "Ảnh công trình 1",
    "desc" => "Đường dẫn ảnh với kích thước chiều rộng tối thiểu 200px",
    "id" => "cong_trinh_image1",
    "std" => " ",
    "type" => "text");

  $options[] = array( "name" => "Công trình 1 image alt",
    "desc" => "Tên của công trình khi ảnh không được hiển thị.",
    "id" => "cong_trinh_alt1",
    "std" => "Công trình 1",
    "type" => "text");

  $options[] = array( "name" => "Công trình 1 Url",
    "desc" => "Nhập url của công trình.",
    "id" => "cong_trinh_url1",
    "std" => "http://congtrinhdep.com/",
    "type" => "text");

  //Công trình 2
  $options[] = array( "name" => "Tên công trình 2",
    "desc" => "Nhập tên công trình.",
    "id" => "cong_trinh_title2",
    "std" => "Resort phố Huế.",
    "type" => "text");

  $options[] = array( "name" => "Ảnh công trình 2",
    "desc" => "Đường dẫn ảnh với kích thước chiều rộng tối thiểu 200px",
    "id" => "cong_trinh_image2",
    "std" => " ",
    "type" => "text");

  $options[] = array( "name" => "Công trình 2 image alt",
    "desc" => "Tên của công trình khi ảnh không được hiển thị.",
    "id" => "cong_trinh_alt2",
    "std" => "Công trình 2",
    "type" => "text");

  $options[] = array( "name" => "Công trình 2 Url",
    "desc" => "Nhập url của công trình.",
    "id" => "cong_trinh_url2",
    "std" => "http://congtrinhdep.com/",
    "type" => "text");
  ...
  //Công trình 3
  $options[] = array( "name" => "Tên công trình 3",
    "desc" => "Nhập tên công trình.",
    "id" => "cong_trinh_title3",
    "std" => "Resort phố Huế.",
    "type" => "text");

  $options[] = array( "name" => "Ảnh công trình 3",
    "desc" => "Đường dẫn ảnh với kích thước chiều rộng tối thiểu 200px",
    "id" => "cong_trinh_image3",
    "std" => " ",
    "type" => "text");

  $options[] = array( "name" => "Công trình 3 image alt",
    "desc" => "Tên của công trình khi ảnh không được hiển thị.",
    "id" => "cong_trinh_alt3",
    "std" => "Công trình 3",
    "type" => "text");

  $options[] = array( "name" => "Công trình 3 Url",
    "desc" => "Nhập url của công trình.",
    "id" => "cong_trinh_url3",
    "std" => "http://congtrinhdep.com/",
    "type" => "text");
  ...
  //Công trình 4
  $options[] = array( "name" => "Tên công trình 4",
    "desc" => "Nhập tên công trình.",
    "id" => "cong_trinh_title4",
    "std" => "Resort phố Huế.",
    "type" => "text");

  $options[] = array( "name" => "Ảnh công trình 4",
    "desc" => "Đường dẫn ảnh với kích thước chiều rộng tối thiểu 200px",
    "id" => "cong_trinh_image4",
    "std" => " ",
    "type" => "text");

  $options[] = array( "name" => "Công trình 4 image alt",
    "desc" => "Tên của công trình khi ảnh không được hiển thị.",
    "id" => "cong_trinh_alt4",
    "std" => "Công trình 4",
    "type" => "text");

  $options[] = array( "name" => "Công trình 4 Url",
    "desc" => "Nhập url của công trình.",
    "id" => "cong_trinh_url4",
    "std" => "http://congtrinhdep.com/",
    "type" => "text");
  ...
  $options[] = array( "name" => "Khách hàng tiêu biểu",
    "type" => "heading");

  //Khách hàng 1
  $options[] = array( "name" => "Tên Khách hàng 1",
    "desc" => "Nhập tên Khách hàng.",
    "id" => "khach_hang_title1",
    "std" => "Khách hàng Cafe",
    "type" => "text");

  $options[] = array( "name" => "Ảnh Khách hàng 1",
    "desc" => "Đường dẫn ảnh với kích thước chiều rộng tối thiểu 200px",
    "id" => "khach_hang_image1",
    "std" => " ",
    "type" => "text");

  $options[] = array( "name" => "Khách hàng 1 image alt",
    "desc" => "Tên của Khách hàng khi ảnh không được hiển thị.",
    "id" => "khach_hang_alt1",
    "std" => "Khách hàng 1",
    "type" => "text");

  $options[] = array( "name" => "Khách hàng 1 Url",
    "desc" => "Nhập url của Khách hàng.",
    "id" => "khach_hang_url1",
    "std" => "http://congtrinhdep.com/",
    "type" => "text");

  //Khách hàng 2
  $options[] = array( "name" => "Tên Khách hàng 2",
    "desc" => "Nhập tên Khách hàng.",
    "id" => "khach_hang_title2",
    "std" => "Resort phố Huế.",
    "type" => "text");

  $options[] = array( "name" => "Ảnh Khách hàng 2",
    "desc" => "Đường dẫn ảnh với kích thước chiều rộng tối thiểu 200px",
    "id" => "khach_hang_image2",
    "std" => " ",
    "type" => "text");

  $options[] = array( "name" => "Khách hàng 2 image alt",
    "desc" => "Tên của Khách hàng khi ảnh không được hiển thị.",
    "id" => "khach_hang_alt2",
    "std" => "Khách hàng 2",
    "type" => "text");

  $options[] = array( "name" => "Khách hàng 2 Url",
    "desc" => "Nhập url của Khách hàng.",
    "id" => "khach_hang_url2",
    "std" => "http://congtrinhdep.com/",
    "type" => "text");
  ...
  //Khách hàng 3
  $options[] = array( "name" => "Tên Khách hàng 3",
    "desc" => "Nhập tên Khách hàng.",
    "id" => "khach_hang_title3",
    "std" => "Resort phố Huế.",
    "type" => "text");

  $options[] = array( "name" => "Ảnh Khách hàng 3",
    "desc" => "Đường dẫn ảnh với kích thước chiều rộng tối thiểu 200px",
    "id" => "khach_hang_image3",
    "std" => " ",
    "type" => "text");

  $options[] = array( "name" => "Khách hàng 3 image alt",
    "desc" => "Tên của Khách hàng khi ảnh không được hiển thị.",
    "id" => "khach_hang_alt3",
    "std" => "Khách hàng 3",
    "type" => "text");

  $options[] = array( "name" => "Khách hàng 3 Url",
    "desc" => "Nhập url của Khách hàng.",
    "id" => "khach_hang_url3",
    "std" => "http://congtrinhdep.com/",
    "type" => "text");
  ...
  //Khách hàng 4
  $options[] = array( "name" => "Tên Khách hàng 4",
    "desc" => "Nhập tên Khách hàng.",
    "id" => "khach_hang_title4",
    "std" => "Resort phố Huế.",
    "type" => "text");

  $options[] = array( "name" => "Ảnh Khách hàng 4",
    "desc" => "Đường dẫn ảnh với kích thước chiều rộng tối thiểu 200px",
    "id" => "khach_hang_image4",
    "std" => " ",
    "type" => "text");

  $options[] = array( "name" => "Khách hàng 4 image alt",
    "desc" => "Tên của Khách hàng khi ảnh không được hiển thị.",
    "id" => "khach_hang_alt4",
    "std" => "Khách hàng 4",
    "type" => "text");

  $options[] = array( "name" => "Khách hàng 4 Url",
    "desc" => "Nhập url của Khách hàng.",
    "id" => "khach_hang_url4",
    "std" => "http://congtrinhdep.com/",
    "type" => "text");
