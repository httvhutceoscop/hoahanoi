...
<div class="container">
  <div id="head">
    ...
    <div class="twelve columns omega" id="headright">
      <div id="topbar">
        <ul class="social">
          <li><a href=" https://twitter.com/<?php echo of_get_option('w2f_twitter'); ?> "> <img
                src="<?php echo get_template_directory_uri(); ?>/images/twit.png"> </a></li>
          <li><a href="<?php echo of_get_option('w2f_facebook'); ?>"> <img
                src="<?php echo get_template_directory_uri(); ?>/images/facebook.png"> </a></li>
          <li><a href="<?php echo of_get_option('w2f_google'); ?>"> <img
                src="<?php echo get_template_directory_uri(); ?>/images/gplus.png"> </a></li>
<!--          <li><a href="--><?php //bloginfo('rss2_url'); ?><!--"> <img src="--><?php //echo get_template_directory_uri(); ?><!--/images/rss.png"> </a>-->
<!--          </li>-->
<!--          <li><a href="http://del.icio.us/post?url= --><?php //echo get_permalink() ?><!-- "> <img-->
<!--                src="--><?php //echo get_template_directory_uri(); ?><!--/images/del.png"> </a></li>-->
<!--          <li><a href="--><?php //echo of_get_option('w2f_linkedin'); ?><!--"> <img-->
<!--                src="--><?php //echo get_template_directory_uri(); ?><!--/images/in.png"> </a></li>-->
        </ul>
        <?php get_search_form(); ?>
      </div>
      <div id="botmenu">
